 ...
 */
function roundCoordinate(coordinate, decimalPlaces = 3) {
 ...
 */
function roundCoordinates(latitude, longitude, decimalPlaces = 3) {
  return {
 ...
 * @param {number} decimalPlaces - Number of decimal places for comparison (default: 3)
 * @returns {boolean} True if coordinates are equal when rounded
 */
function areCoordinatesEqual(lat1, lng1, lat2, lng2, decimalPlaces = 3) {
